...
---
Solution of my case study consists of Python script to retrieve and transform the data, SQL script for creation of the "twitter" database and this page to present the result of the analysis.
